...
- `2.0.0-preview2`, `2.0`, `2`
    - [`2.0.0-preview2-jessie` (*Dockerfile*)](https://github.com/aspnet/aspnet-docker/blob/master/2.0/jessie/sdk/Dockerfile)
...
- `1.0-2.0-preview2-2017-05`, `1.0-2.0-preview2` (designed for CI builds)
    - [`1.0-2.0-preview2-2017-05-jessie` (designed for CI builds), (*Dockerfile*)](https://github.com/aspnet/aspnet-docker/blob/master/2.0/jessie/kitchensink/Dockerfile)
    - [`1.0-2.0-preview2-2017-05-nanoserver` (designed for CI builds), (*Dockerfile*)](https://github.com/aspnet/aspnet-docker/blob/master/2.0/nanoserver/kitchensink/Dockerfile)
